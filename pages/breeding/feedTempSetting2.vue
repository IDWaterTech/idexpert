                ...
                <v-card class="result-card">
                    ...
                    <div class="content">
                        <div class="search">
                            ...
                            <!-- </v-autocomplete> -->
                            <div>
                                <FeedTemplate2 v-if="editmode=='add'" @action="actionResult" :templatemode="editmode" :accdata="[]" :nowExpand="nowExpand"></FeedTemplate2>
                                <FeedTemplate2 v-if="editmode=='edit'" @action="actionResult" :key="editKey" :templatemode="editmode" :passObj="passObj" :accdata="[]" :nowExpand="nowExpand"></FeedTemplate2>
                            </div>
                        </div>
