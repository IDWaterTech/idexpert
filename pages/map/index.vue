              ...
              <v-row style="margin-top: 0;">
                  <v-col cols="12"
                      ...
                      <div v-if="areas.length > 0" class="tabs">
                          <v-tabs v-model="nowAreaTag" show-arrows>
                              <div class="icons">
                              ...
                              <div v-if="nowAreaTag=='setting'" class="layout-box">
                              ...
                              <v-tabs-items v-model="nowAreaTag" touchless>
                                ...
                                >
                                  <poollayout  id="layout" :areas="areas" :nowAreaTag="nowAreaTag" :nowAreaId="nowAreaId" :showedit="mapshowedit" :statcolor="statcolor" :successData="successData" :setting="setting" :nowLayout="nowLayout" @editPoolOuter="edit($event)" @saveSuccess="saveDelete($event)"></poollayout>
                      ...
                      <div v-show="areas.length == 0" class="nodata tabs">無資料!請先至<router-link to="/factory"> 資料設定頁 </router-link>進行區的設定</div>
