...
export default {
  ...
  data() {
    return {
      player: undefined,
      // url: `${this.$store.state.mydata.gobal_api.apiVideo8443}/live/170.flv`,
      url: `${this.$store.state.mydata.gobal_api.apiVideo8443}/live/171/index.m3u8`,
      type: "hls"
    };
  },
  async created() {
  ...
  methods: {
    chchanel: function(data) {
      this.url = `${this.$store.state.mydata.gobal_api.apiVideo8443}/live/${data}/index.m3u8`;
      // this.player.pause();
