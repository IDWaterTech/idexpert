          ...
          <div class="result">
            <div class="result-card">
              ...
              <!-- <v-row style="margin-bottom: 4px;">
                <v-col cols="12" md="4" sm="4"  style="padding-top: 0; padding-bottom: 0;">
              ...
              <!-- 統整小卡 養殖池 -->
              <v-row style="margin-bottom: 4px;width: 100%;align-items: flex-start;height: 100%;position: relative;" id="chart">
                <!-- 統整小卡 直式 -->
