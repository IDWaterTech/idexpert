                                            ...
                                            <v-card tile color="#BBDEFB">
                                                ...
                                                <v-card-text class="pa-0 mx-0">
                                                    <v-form ref="BacteriaData">
                                                        ...
                                                        <v-select v-model="BacteriaData['IsIMNV']" clearable :items="optData.IsIMNV" filled dense hide-details class="mt-0 yellow" item-value="name_en" item-text="name_ch"><span style="width:200px;" class="pa-0 ma-0 text-center" slot="prepend">是否IMNV感染</span></v-select>
